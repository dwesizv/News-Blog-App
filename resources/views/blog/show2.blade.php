...
<header class="masthead" style="background-image: url('{{ url('assets/img/noticia.jpg') }}')">
...
<footer class="border-top">
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            ...
            <div class="small text-center text-muted fst-italic">Copyright &copy; Dwes Tarde {{ date('Y') }}</div>
        </div>
    </div>
</footer>
@endsection